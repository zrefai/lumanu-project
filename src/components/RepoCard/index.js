...
Card.IHContainer = function CardInfoHeaderContainer({ children, ...otherProps}) {
...
Card.IFContainer = function CardInfoFoorterContainer({ children, ...otherProps }) {
...
Card.RBContainer = function CardRemoveButtonContainer({ children, ...otherProps}) {
...
const RepoCard = ({ repo }) => {
    ...
    const renderRemoveButton = () => {
        return (
            <RemoveButtonContainer>
                <Card.RButton onClick={(e) => handleRemoveCard(e)}><FaTimes/></Card.RButton>
            </RemoveButtonContainer>
        )
    }
